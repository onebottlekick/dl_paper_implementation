...
class ResNet(nn.Module):
    def __init__(self, block, layers, image_channels, num_classes):
        ...
        self.layer1 = self._layer(block, layers[0], intermediate_channels=64, stride=1)
        self.layer2 = self._layer(block, layers[1], intermediate_channels=128, stride=2)
        self.layer3 = self._layer(block, layers[2], intermediate_channels=256, stride=2)
        self.layer4 = self._layer(block, layers[3], intermediate_channels=512, stride=2)
    ...
    def _layer(self, block, num_residual_blocks, intermediate_channels, stride):
